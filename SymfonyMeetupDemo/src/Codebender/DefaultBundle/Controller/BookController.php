...
namespace Codebender\DefaultBundle\Controller;
...
use Codebender\DefaultBundle\Entity\Book;
use Codebender\DefaultBundle\Form\BookType;
...
class BookController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        try
        {
            $entities = $em->getRepository('CodebenderDefaultBundle:Book')->findAll();
        }
        catch(\Exception $e)
        {
     ...
     * @Method("POST")
     * @Template("CodebenderDefaultBundle:Book:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodebenderDefaultBundle:Book')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodebenderDefaultBundle:Book:edit.html.twig")
     */
